...
public class Queue {
    ...
    public Queue(String queue_name, String queue_description, String queue_business, String queue_QRCodeImage, String queue_image, String queue_city, String queue_businessID, int queue_nMaxReservation, int queue_nReservation) {
